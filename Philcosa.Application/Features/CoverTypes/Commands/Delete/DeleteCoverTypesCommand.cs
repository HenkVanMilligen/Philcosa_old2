...
{
    public class DeleteCoverTypesCommand : IRequest<Result<int>>
    {
        public int Id { get; set; }
    }

    public class DeleteCoverTypesCommandHandler : IRequestHandler<DeleteCoverTypesCommand, Result<int>>
    {
        private readonly ICoverTypeRepository _coverTypeRepository;
        private readonly IStringLocalizer<DeleteCoverTypesCommandHandler> _localizer;
        private readonly IUnitOfWork _unitOfWork;

        public DeleteCoverTypesCommandHandler(IUnitOfWork unitOfWork, ICoverTypeRepository coverTypeRepository, IStringLocalizer<DeleteCoverTypesCommandHandler> localizer)
        {
        ...
        public async Task<Result<int>> Handle(DeleteCoverTypesCommand command, CancellationToken cancellationToken)
        {
