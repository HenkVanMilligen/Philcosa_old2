...
{
    public partial class AddEditCoverTypeModal
    {
        ...
        [Parameter]
        public AddEditCoverTypeCommand AddEditCoverTypeModel { get; set; } = new();
        ...
        {
            var response = await _coverTypeManager.SaveAsync(AddEditCoverTypeModel);
