...
{
    public partial class AddEditThemeModal
    {
        ...
        [Parameter]
        public AddEditThemeCommand AddEditThemeModel { get; set; } = new();
        ...
        {
            var response = await _themeManager.SaveAsync(AddEditThemeModel);
